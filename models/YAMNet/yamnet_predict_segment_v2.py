...
class YAMNetClassifier:
    """Classify sounds using the YAMNet pre-trained model."""
    ...
    def _visualize_results(self, waveform, spectrogram_np, scores_np, result_fig_path, sample_rate, top_n=10):
        """Visualize waveform, spectrogram, and top predicted classes with units."""
